 ...
 * @author binhNC
 */
public class bc6 extends javax.swing.JFrame {
        ...
        try {
            ...
            if (conn != null) {
                try {
                    ...
                    Logger.getLogger(bc6.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
    }
    ...
    private void initComponents() {
        ...
        setTitle("TỔNG HỢP NHỮNG KHÁCH HÀNG QUÁ HẠN THANH TOÁN");
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bc6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
