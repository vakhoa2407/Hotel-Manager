...
public class main_khachHang extends javax.swing.JFrame {
    ...
    public main_khachHang(String username) {
        initComponents();
    ...
    public void showKhachHang() {
        ...
        list = test.findAll(txtTimKiem.getText());
        ...
        list.forEach((khachHang) -> {
            tableModel.addRow(new Object[]{/*tableModel.getRowCount() + 1*/khachHang.getMaKH(), khachHang.getTenKH(),
                khachHang.getNgaySinh(), khachHang.getGioiTinh(), khachHang.getCmt(), khachHang.getSdt()});
        });
    }
    ...
    private void initComponents() {
        ...
        lbTimKiem.setText("Tìm kiếm theo mã khách hàng:");
        ...
        tblKhachHang.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã khách hàng", "Tên khách hàng", "Ngày sinh", "Giới tính", "CMT/CCCD", "Số điện thoại"
            }
        ));
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(txtCCCD, javax.swing.GroupLayout.DEFAULT_SIZE, 161, Short.MAX_VALUE)
            ...
            try {
                ...
                if (conn != null) {
                    try {
                        ...
                        Logger.getLogger(main_khachHang.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
            }
        }
    ...
    private void tblKhachHangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblKhachHangMouseClicked
        ...
        if (selectedIndex >= 0) {
            khachHang std = list.get(selectedIndex);
            txtMaKH.setText(std.getMaKH());
            txtTenKH.setText(std.getTenKH());
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        long year_curr = cal.get(Calendar.YEAR);
        System.out.println("year current: " + year_curr);

        SimpleDateFormat only_year = new SimpleDateFormat("yyyy");
        String year = only_year.format(dateNgaySinh.getDate().getTime());
        long year_date = Long.valueOf(year);
        System.out.println("year date: " + year_date);
        System.out.println("Year full: " + ngaySinh);

        if (selectedIndex >= 0) {
            if (!txtCCCD.getText().trim().matches("^\\d{12}$")) {
                System.out.println("Sai định dạng CMT/CCCD");
                JOptionPane.showMessageDialog(this, "Sai định dạng CMT/CCCD");
                txtCCCD.requestFocus(true);
                txtCCCD.selectAll();
            } else if (!txtSDT.getText().trim().matches("^0\\d{9}$")) {
                ...
                txtSDT.requestFocus(true);
                txtSDT.selectAll();
            } else if ((year_date + 18) >= year_curr) {
                ...
                if (option == 0) {
                    ...
                    conn = con.getConnection();
                    try {
                        String sql = "UPDATE dbo.tbl_khachhang SET tenKH=?,ngaySinh=?,gioiTinh=?,cmt=?,sdt=? WHERE maKH=?";
                        PreparedStatement statement = conn.prepareCall(sql);
                        System.out.println(txtMaKH.getText());

                        statement.setString(1, txtTenKH.getText());
                        statement.setString(2, ngaySinh.toString());
                        statement.setString(3, txtGioiTinh);
                        statement.setString(4, txtCCCD.getText().trim());
                        statement.setString(5, txtSDT.getText().trim());
                        statement.setString(6, txtMaKH.getText().trim());
